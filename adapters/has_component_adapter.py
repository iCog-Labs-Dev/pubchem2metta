...
class HasComponentEdge(Adapter):
    ...
    def get_edges(self):
        ...
        edges = list(self.graph.subject_objects(predicate=self.HAS_COMPONENT, unique=True))
        ...
        for edge in tqdm(edges, desc="Loading compounds", unit="compound"):
            ...
            predicate_key = self.to_key(self.HAS_COMPONENT)
